...
from src.helpers.CustomTypes import SpectrumModule

analyse_modules: Dict[str, SpectrumModule] = {}
...
for file in os.listdir(__path__[0]):
    ...
    try:
        ...
        valid_module: SpectrumModule = module_candidate  # type: ignore
    except AssertionError:
        print(f"Module {file} is invalid. It's missing `analyse` method")
        continue

    analyse_modules[file] = valid_module
    del file, valid_module, module_candidate

del os, il, Dict, SpectrumModule
